...
import type { DesktopTilesSliderProps } from './DesktopTilesSlider.types';

export const desktopTilesSliderMock: DesktopTilesSliderProps = {
...
export default desktopTilesSliderMock;
